...
const EnrollPage = () => {
  ...
  return (
    <div className="w-full ">
      <div className="relative min-h-screen flex flex-col items-center justify-start py-12 pt-4 bg-gray-900">
        ...
        <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            {/* Left Column */}
            <div className="flex flex-col space-y-8 lg:mt-5 lg:mb-5">
              {/* Content Section */}
              <div className="bg-gray-900 backdrop-blur-lg rounded-2xl p-12 shadow-[0_8px_30px_rgb(0,0,0,0.12)] ">
                ...
                <div className="space-y-6">
                  <div className="group flex items-start gap-4 p-4 rounded-xl hover:bg-orange-50/80 transition-all duration-300 border border-transparent hover:border-orange-100">
                    ...
                    <div>
                      <h3 className="font-bold text-white text-lg mb-1 group-hover:text-orange-600 transition-colors">
                        Personalized Career Roadmap
                      </h3>
                      <p className="text-gray-200 leading-relaxed group-hover:text-gray-900">
                  ...
                  <div className="group flex items-start gap-4 p-4 rounded-xl hover:bg-orange-50/80 transition-all duration-300 border border-transparent hover:border-orange-100">
                    ...
                    <div>
                      ...
                      <p className="text-gray-200 leading-relaxed group-hover:text-gray-900">
                        ...
                        mock interviews, career guidance, and placement support
