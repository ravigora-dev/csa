...
const CourseDetailsModal = ({ isOpen, onClose, course }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative w-full max-w-2xl h-[90vh] m-2 sm:m-4 z-10">
        <div className="absolute inset-0 bg-gradient-to-b from-gray-800 to-gray-900 rounded-2xl shadow-2xl overflow-hidden flex flex-col">
          ...
          <div className="p-4 sm:p-6 border-b border-gray-700">
            ...
            <div>
              ...
              <p className="text-sm sm:text-base text-gray-400">{course.description}</p>
            </div>
          </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {course.curriculum.slice(0, 2).map((module, index) => (
                    <div key={index} className="bg-gray-700/30 rounded-lg p-3 sm:p-4">
                      <h4 className="text-sm sm:text-base text-white font-medium mb-2">
                        {module.title}
                      </h4>
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex gap-3">
                  <button 
                    ...
                    className="px-3 sm:px-4 py-2 bg-gray-600 text-white text-sm rounded-lg hover:bg-gray-700 transition-colors flex items-center gap-2"
                  >
                    <svg
                      className="w-4 h-4"
                      fill="none"
                  ...
                  <button 
                    ...
                    className="px-4 sm:px-6 py-2 bg-orange-500 text-white text-sm rounded-lg hover:bg-orange-600 transition-colors"
                  >
                    Enroll Now
                  </button>
                </div>
